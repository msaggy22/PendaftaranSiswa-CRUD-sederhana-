...
<!-- end navbar -->
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <div class="box">
            <img src="assets/img/ujian-nas.jpg" alt="banner">  
          </div>
        </div>
        <div class="col-md-4">
          <div class="box">
          <form>
              ...
              <button type="submit" class="btn btn-success"><i class="bi bi-box-arrow-in-right"></i> Masuk</button>
              <a href="registrasi.php" class="btn btn-primary"><i class="bi bi-person-plus"></i> Daftar Baru</a>
          </form>
          <hr>
          <h6>Informasi Terkait</h6>
              <ul>
                <li><a href="pengumuman.php">Pendaftaran Siswa Baru Tahun Pelajaran 2022/2023</a></li>
                <li><a href="pengumuman.php">Syarat Pendaftaran Siswa Baru Tahun Pelajaran 2022/2023</a></li>
                <li><a href="pengumuman.php">Seleksi Administrasi Siswa Baru Tahun Pelajaran 2022/2023</a></li>
              </ul>
              </div>
          </div>
    </div>
